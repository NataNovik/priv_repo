...
//todo refactor color
    if(color === 'green') {
        ...
        card.style.backgroundImage = `src('https://github.com/NataNovik/priv_repo/tree/codejam-eldritch/data/mythicCards/${color}/${resultCardGreen}.png')`
    }
    if(color === 'blue') {
        ...
        card.style.backgroundImage = `src('https://github.com/NataNovik/priv_repo/tree/codejam-eldritch/data/mythicCards/${color}/${resultCardBlue}.png')`
    ...
    if(color === 'brown') {
        ...
        card.style.backgroundImage = `src('https://github.com/NataNovik/priv_repo/tree/codejam-eldritch/data/mythicCards/${color}/${resultCardBrown}.png')`
    }
}
