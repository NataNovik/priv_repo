...
//todo refactor color
    if(color === 'green') {
        ...
        card.style.backgroundImage = `src: ('https://natanovik.github.io/priv_repo/codejam-eldritch/data/mythicCards/${color}/${resultCardGreen}.png')`
    }
    if(color === 'blue') {
        ...
        card.style.backgroundImage = `('src: https://natanovik.github.io/priv_repo/codejam-eldritch/data/mythicCards/${color}/${resultCardBlue}.png')`
    ...
    if(color === 'brown') {
        ...
        card.style.backgroundImage = `src: ('https://natanovik.github.io/priv_repo/codejam-eldritch/data/mythicCards/${color}/${resultCardBrown}.png')`
    }
}
